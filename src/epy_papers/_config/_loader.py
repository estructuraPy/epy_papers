"""Canonical ``.epyson`` loader for epy_papers's bundled theme assets.
...
``epy_papers._core.epyson``, which consumes these loaders.
"""
...
def read_asset_json(filename: str) -> dict[str, Any]:
    ...
    try:
        ...
        raise FileNotFoundError(
            f"epy_papers theme asset '{filename}' not found in package "
            f"'{ASSETS_PACKAGE}'. Reinstall epy_papers or check the "
