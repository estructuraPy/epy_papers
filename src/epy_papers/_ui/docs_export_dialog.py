"""Dialog for exporting the current manuscript through epy_docs.
...
def _render(**kwargs: Any) -> Any:
    ...
    """
    from epy_papers.epy_suite_connect._adapters import (  # noqa: PLC0415
        docs_bridge,
    )
...
class DocsExportDialog(_Shared):
    ...
    def __init__(
        ...
        Args:
            source_path: Absolute path to the manuscript being exported.
