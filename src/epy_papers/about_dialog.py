...
def _load_branding_pixmap(name: str) -> QPixmap:
    ...
    Args:
        name: Filename inside ``epy_papers.assets.branding``,
            e.g. ``"epy_papers.png"``.
    ...
    """
    try:
        pkg = importlib.resources.files("epy_papers.assets.branding")
...
class AboutDialog(QDialog):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.setWindowTitle("About epy_papers")
        ...
        # --- App name + version ---
        name_lbl = QLabel(
            f"<b>epy_papers</b> &nbsp; v{epy_papers.__version__}"
        )
