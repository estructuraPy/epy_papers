...
theme as a live :func:`epy_papers._previews.theme_preview` swatch so the visual
...
Shared design with epy_slides and epy_reports so the three apps feel identical.
"""
