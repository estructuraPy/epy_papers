...
Run from the project root:
    python src/epy_papers/_core/_packaging/make_icon/__init__.py
"""
...
SRC_PNG = OUT_DIR / "epy_papers.png"
...
def generate() -> None:
    ...
    ico_path = OUT_DIR / "epy_papers.ico"
...
if __name__ == "__main__":
    print("Generating epy_papers icons...")
    generate()
    print("Done.")
