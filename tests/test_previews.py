...
def test_theme_preview_for_every_theme(qapp):
    ...
    from epy_papers._previews import THEME_THUMB, theme_preview
...
def test_layout_preview_for_every_design_block(qapp):
    from epy_papers._design import DESIGN_BLOCKS
...
def test_design_block_dialog_lists_all_blocks(qapp):
    from epy_papers._design import DESIGN_BLOCKS
    from epy_papers.design_block_dialog import DesignBlockDialog
...
def test_theme_gallery_lists_all_themes(qapp):
    from epy_papers import themes
    from epy_papers.theme_gallery_dialog import ThemeGalleryDialog
